...
*This is a Just a modification to tks18 's gindex-v4. all credit goes to him. link to his [Repo](https://github.com/souviktg/ultimate_index_backend)*

**Important** - _This Site Requires My GIndex Live Backend Server to be Running Otherwise the Site will Never Open._

**Important** - _For Setting up of Backend. Visit my GIndex Backend [Repo](https://github.com/souviktg/ultimate_index_backend) for Steps to Setup._
